  ...
  <style>
    ...
    * {
    ...
    .gradient-custom {
      ...
      background: linear-gradient(to right, rgba(204, 0, 0, 0.5), rgba(18, 38, 59, 1))
    }
  </style>
</head>
            ...
            <div class="card bg-dark text-white" style="border-radius: 1rem;">
              <div class="card-body">
                ...
                <div class="mb-md-5 mt-md-4 pb-5 ">
                  ...
                  <h4 class="fw-Courier New mb-2 text-uppercase">CHARTVIEW</h4><br>
